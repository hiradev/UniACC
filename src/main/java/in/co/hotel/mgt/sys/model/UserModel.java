...
import in.co.hotel.mgt.sys.exception.RecordNotFoundException;
import in.co.hotel.mgt.sys.util.EmailBuilder;
import in.co.hotel.mgt.sys.util.EmailMessage;
import in.co.hotel.mgt.sys.util.EmailUtility;
	...
	public void update(UserBean bean) throws ApplicationException, DuplicateRecordException {
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement(
					"UPDATE H_USER SET FIRSTNAME=?,LASTNAME=?,LOGIN=?,PASSWORD=?,MOBILENO=?,ROLEID=?,"
